...
export default function MobileNavigation({ navHeadFirst, NavHeadSec }: Props) {
  ...
  return (
    <div>
      <div className="fixed left-0 top-0 z-40 flex h-[50px] w-full items-center justify-between bg-[#252525] p-4 md:hidden">
        <h1 className="font-Open_Sans text-[25px] font-bold uppercase text-white">
