...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, closeSidebar }) => {
  ...
  return (
    <div>
      <div
        className={`fixed right-0 top-0 z-50 h-fit w-[100%] transform overflow-y-auto bg-[#252525] shadow-lg outline-none transition-transform duration-300 md:w-[50%] lg:w-[25%] ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
        <SimpleBar onClick={closeSidebar} style={{ maxHeight: "100%" }}>
          ...
          {menuIcons.map((menu, idx) => (
            ...
            >
              ...
              <h4
                className="relative z-10 font-Poppins text-[19px] font-medium leading-[41.6px] text-white duration-300"
                style={{
